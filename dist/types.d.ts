...
export type KeealWebhookEventType = "checkout.session.completed" | "checkout.session.payment_failed" | "checkout.session.expired" | "checkout.session.canceled" | "checkout.session.abandoned" | "subscription.created" | "subscription.activated" | "subscription.updated" | "subscription.cancelled" | "subscription.invoice_created" | "subscription.payment_failed";
