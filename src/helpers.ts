 ...
 */
export function openCheckoutInNewTab(checkoutUrl: string): void {
 ...
 */
export function assertSingleCurrency(lineItems: { price_data: { currency: string } }[]): void {
 ...
 */
export function previewTotalCents(lineItems: { price_data: { unit_amount: number }; quantity: number }[]): number {
